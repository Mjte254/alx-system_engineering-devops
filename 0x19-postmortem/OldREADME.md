...
<meta name="csrf-token" content="TLrSooTw7WPY+fXF2kAj2aoFp9sI4CgVARZ6GPePw5sdW9HTZHcNk3S4wJXlfVD9xKabG4ld/vodMdqLjr9bVA==" />
...
<div id="project_id" style="display: none" data-project-id="294"></div>
...
<p>
  ...
  <p>
    <small>
      <i class="fa fa-calendar"></i>
        Ongoing project - started 01-22-2018, must end by 01-29-2018 (in 6 days)
...
<ul>
<li><a href="/rltoken/QTu2_ZVW8f-2weQGOQvc9w" title="Incident Report, also referred to as a Postmortem" target="_blank">Incident Report, also referred to as a Postmortem</a></li>
<li><a href="/rltoken/uost5-f-wlp7CV2a6OLVKQ" title="How to run a Postmortem" target="_blank">How to run a Postmortem</a></li>
</ul>

<p><a href="https://youtu.be/rp5cVMNmbro" target="_blank"><img src="http://i.imgur.com/tWUPWmR.png" alt="Let&#39;s chat about Postmortem"></a></p>
...
<li>And to ensure that the root cause(s) of the outage has been discovered and that measures are taken to make sure it will be fixed.</li>
    ...
    <section class="formatted-content">
          <div data-role="task1629" data-position="1">
              <div class=" clearfix gap" id="task-1629">
<span id="user_id" data-id="214"></span>

    <div class="student_task_controls">

      <!-- button Done -->
        <button class="student_task_done btn btn-default no" data-task-id="1629">
      ...
      <!-- button Help! -->
      <button class="users_done_for_task btn btn-default btn-default" data-task-id="1629" data-project-id="294" data-toggle="modal" data-target="#task-1629-users-done-modal">
        Help
      </button>
      <div class="modal fade users-done-modal" id="task-1629-users-done-modal" data-task-id="1629" data-project-id="294">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title">Students who are done with "My first postmortem"</h4>
            </div>
...
<!-- Task Body -->
  <p><a href="https://twitter.com/devopsreact/status/834887829486399488" target="_blank"><img src="http://i.imgur.com/pQ9YzVY.gif" alt="postmortem"></a></p>
  ...
  <!-- Task URLs -->
    <div class="blog_post_div">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-11">
          <input id="input_1629" type="text" value=""  class="form-control"></input>
        </div>
        <div class="col-sm-1">
          <button data-task-requesting="0" data-user-id="214" data-task-id="1629" type="button" class="add_task_url">
    ...
    <ul>
      <li>GitHub repository: <code>holberton-system_engineering-devops</code></li>
        ...
        <li>File: <code>README.md</code></li>
          ...
          <div data-role="task2465" data-position="2">
              <div class=" clearfix gap" id="task-2465">
<span id="user_id" data-id="214"></span>

    <div class="student_task_controls">

      <!-- button Done -->
        <button class="student_task_done btn btn-default no" data-task-id="2465">
          <span class="no"><i class="fa fa-square-o"></i></span>
          <span class="yes"><i class="fa fa-check-square-o"></i></span>
          <span class="pending"><i class="fa fa-spinner fa-pulse"></i></span>
          Done<span class="no pending">?</span><span class="yes">!</span>
      ...
      <!-- button Help! -->
      <button class="users_done_for_task btn btn-default btn-default" data-task-id="2465" data-project-id="294" data-toggle="modal" data-target="#task-2465-users-done-modal">
        Help
      </button>
      <div class="modal fade users-done-modal" id="task-2465-users-done-modal" data-task-id="2465" data-project-id="294">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title">Students who are done with "Make people want to read your postmortem"</h4>
            </div>
            <div class="modal-body">
              <div class="list-group">
              </div>
  ...
  <!-- Task URLs -->
    <div class="blog_post_div">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-11">
          <input id="input_2465" type="text" value=""  class="form-control"></input>
        </div>
        <div class="col-sm-1">
          <button data-task-requesting="0" data-user-id="214" data-task-id="2465" type="button" class="add_task_url">
            <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
          </button>
        </div>
      </div>
